...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Benaiah look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Benaiah need to see?`,
    ...
    {
      headline: `What should ${label} Benaiah tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label="Benaiah"
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-sans font-extrabold uppercase leading-[0.9] tracking-[0.1em] text-midground mix-blend-plus-lighter dark:text-foreground/90"
