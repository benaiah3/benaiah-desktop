...
export const en: Translations = {
  ...
  boot: {
    ready: 'Benaiah Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Benaiah settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Benaiah Desktop…'
    },
    errors: {
      backgroundExited: 'Benaiah background process exited.',
      backgroundExitedDuringStartup: 'Benaiah background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Benaiah backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Benaiah',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Benaiah Desktop.',
    ...
    native: {
      ...
      inputBody: 'Benaiah is waiting for your response.',
      turnDoneTitle: 'Benaiah finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Benaiah defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Benaiah is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Benaiah asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Benaiah was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Benaiah follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Benaiah can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Benaiah is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Benaiah, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Benaiah checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Benaiah configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Benaiah.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Benaiah backend elsewhere. Per-profile overrides below.',
      ...
      localDesc: 'Start a private Benaiah backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Benaiah backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Benaiah Cloud',
      cloudDesc: 'Sign in once to Benaiah Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Benaiah Cloud',
      cloudSignIn: 'Sign in to Benaiah Cloud',
      cloudSignedIn: 'Signed in to Benaiah Cloud',
      cloudNeedsSignIn: 'Sign in to Benaiah Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Benaiah Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Benaiah Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Benaiah Cloud',
      cloudSignedOutMessage: 'Cleared the Benaiah Cloud session.',
      ...
      restartingMessage: 'Benaiah Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Benaiah ${version}` : ''}`,
      ...
      sshDesc:
        'Benaiah is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Benaiah path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Benaiah found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Benaiah runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Benaiah is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Benaiah path.',
      sshErrPlatform:
        'Unsupported remote platform. Benaiah Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Benaiah on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Benaiah runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Benaiah at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with your Benaiah plan — connect your Benaiah account to activate.',
      nousAuthNeededTitle: 'Connect your Benaiah account',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you connect your Benaiah account.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Benaiah account connected',
      nousAuthDoneMessage: 'Your plan-backed tools are now active.',
      nousAuthFailed: 'Benaiah account sign-in did not complete',
  ...
  starmap: {
    ...
    emptyDesc: 'As Benaiah builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Benaiah to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Benaiah to generate pets.',
      backgroundHint: 'You can close this — Benaiah will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Benaiah desktop' },
    ...
    hermesActiveSessions: (version, count) => `Benaiah ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Benaiah environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Benaiah will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Benaiah backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Benaiah. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Benaiah...',
    placeholderReconnecting: 'Reconnecting to Benaiah…',
    ...
    attachUrlDesc: 'Benaiah will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Benaiah to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Benaiah…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Benaiah…',
    ...
    unsupportedMessage: 'This version of Benaiah can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Benaiah is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Benaiah backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Benaiah from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Benaiah will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Benaiah desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Benaiah updater takes over in its own window and reopens Benaiah automatically when it’s done. Please don’t reopen Benaiah yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Benaiah reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Benaiah reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Benaiah needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Benaiah on this computer',
    setupChoiceDesc:
      'Recommended for most people. Benaiah will prepare a private workspace on this computer and open when it’s ready.',
    connectExistingTitle: 'Advanced connection options',
    connectExistingShort: 'Connect existing',
    connectExistingDesc: 'Connect Benaiah Cloud, a remote gateway or another computer.',
    installLocalTitle: 'Set up on this computer',
    installLocalDesc: 'Recommended. Keeps Benaiah and its workspace private on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Benaiah Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Benaiah',
    remoteSetupDesc: 'Enter your gateway URL. Benaiah Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Benaiah gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/benaiah',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Benaiah gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Benaiah Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Benaiah CLI or desktop instance is running. Stop any running Benaiah instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Benaiah installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
    ...
    transcriptSaved: 'Technical log saved securely on this device.',
    copiedOutput: 'Copied!',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Benaiah Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Benaiah is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Benaiah…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One Benaiah account — your plan, models and usage connected automatically',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Benaiah at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Benaiah connects automatically',
    ...
    authorizeThere: 'Authorize Benaiah there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Benaiah there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Benaiah Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Benaiah Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Benaiah will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Benaiah is restarting...',
      askRestart: 'Ask Benaiah to restart the server',
      lookingRestart: taskId => `Benaiah is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Benaiah is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Benaiah finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Benaiah could not restart the server.',
      stillWorking:
        'Benaiah is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Benaiah is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Benaiah gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Benaiah won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Benaiah needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Benaiah needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Benaiah Desktop to use Save Image.',
    restartToSaveImages: 'Restart Benaiah Desktop to save images',
