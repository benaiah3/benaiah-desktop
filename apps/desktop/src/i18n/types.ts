...
export interface Translations {
  ...
  composer: {
    ...
    wakeWordListening: (phrase: string, secondaryPhrase?: string) => string
    wakeWordOff: (phrase: string, secondaryPhrase?: string) => string
    wakeWordPausedVoice: (phrase: string, secondaryPhrase?: string) => string
