...
def _resume_voice_wake() -> None:
    """Return microphone ownership to the wake detector after voice capture."""
...
def _(rid, params: dict) -> dict:
    ...
    try:
        if action == "start":
            ...
            # The wake detector and transcription intentionally share one
            # microphone. Yield it for this turn, then re-arm "Hey Benaiah"
            # when capture reaches a terminal state.
            try:
                from tools.wake_word import pause_listening
